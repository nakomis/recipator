...
const RULES: Record<string, string[]> = {
  ...
  condiments: [
    ...
    'curry powder', 'cinnamon', 'oregano', 'garlic powder', 'onion powder',
    'ground ginger', 'chilli powder', 'chili powder', 'turmeric', 'ground cumin',
    'ground coriander', 'garam masala', 'mixed herbs', 'dried herbs', 'seasoning',
    'honey', 'jam', 'marmalade', 'peanut butter',
